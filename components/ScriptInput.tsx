               ...
               {characters.map(char => (
                 <div key={char.id} className="bg-slate-950/50 border border-slate-800 p-4 rounded-xl relative group">
                    ...
                    <div className="mb-3 bg-amber-500/10 border border-amber-500/20 p-2 rounded-lg">
                      ...
                      />
                      <p className="text-[9px] text-slate-500 mt-1 leading-tight">Nếu là người thật: dùng MÃ DANH đã duyệt (A Khan, A Lu, A Chen, A Chi, Ba Mom, May Phuong...) hoặc danh xưng "the ..." — chắc chắn không trùng tên ai.</p>
                    </div>
